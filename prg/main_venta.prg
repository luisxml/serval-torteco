...
PUBLIC Vgc_clic,Vgn_opt,Vgc_cliente2,conex,Vgn_tipousu,Vgc_serie,Vgc_nomb_usu,Vgn_actual,fg_conectado,Vgn_super_user,VPC_llave,Vgc_caja,caja,Vgc_barras, Vgc_direccion
Vgc_direccion = ''
Vgc_barras =0 
Vgn_super_user=0
fg_conectado=0
...
*****VERSION
Vgc_version='1.0.0.20'
Vgc_vigencia='19/02/2020'
***VERSION
SET STEP ON
